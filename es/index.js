...
import Draggable from 'react-draggable'; //import Sortable, {Swap} from 'sortablejs'
...
import { adjustVolume, arrayEqual, createRandomNum, formatTime, isSafari, uuId } from './utils'; //Sortable.mount(new Swap())
